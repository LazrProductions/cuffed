...
public class DuckTapeArmsRestraint extends AbstractArmRestraint implements IBreakableRestraint {
    ...
    public DuckTapeArmsRestraint() {

    }
    public DuckTapeArmsRestraint(ItemStack stack, ServerPlayer player, ServerPlayer captor) {
        super(stack, player, captor);
    }

    // #region Restraint Properties

    public static final ResourceLocation ID = ModRestraints.DUCK_TAPE_ARMS.getId();
    public ResourceLocation getId() {
        return ID;
    }

    public String getActionBarLabel() {
        return "info.cuffed.restraints.duck_tape_arms.action_bar";
    }
    public String getName() {
        return "info.cuffed.restraints.duck_tape_arms.name";
    }
    ...
    public RestraintModelInterface getModelInterface() {
        return new DuckTapeArmsRestraintModelInterface();
    }
    ...
    @OnlyIn(Dist.CLIENT)
    public static class DuckTapeArmsRestraintModelInterface extends RestraintModelInterface { 
