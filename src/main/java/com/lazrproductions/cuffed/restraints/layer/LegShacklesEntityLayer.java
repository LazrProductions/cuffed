...
public class LegShacklesEntityLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends LegShacklesModel<T>>
    ...
    public LegShacklesEntityLayer(RenderLayerParent<T, M> parent, A model) {
        super(parent);
        this.model = model;
    }
    ...
    public void render(@Nonnull PoseStack stack, @Nonnull MultiBufferSource buffer, int lighting, @Nonnull T entity,
        ...
        if (res.getLegRestraintId().equals(LegShacklesRestraint.ID)) {
