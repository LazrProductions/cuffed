...
public class HandcuffEntityLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends HandcuffsModel<T>>
    ...
    public HandcuffEntityLayer(RenderLayerParent<T, M> parent, A model) {
        super(parent);
        this.model = model;
    }
    ...
    public void render(@Nonnull PoseStack stack, @Nonnull MultiBufferSource buffer, int lighting, @Nonnull T entity,
        ...
        if (res.getArmRestraintId().equals(HandcuffsRestraint.ID)) {
