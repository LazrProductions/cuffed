...
public class ShacklesEntityLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends ShacklesModel<T>>
    ...
    public void render(@Nonnull PoseStack stack, @Nonnull MultiBufferSource buffer, int lighting, @Nonnull T entity,
        ...
        if (res.getArmRestraintId().equals(ShacklesRestraint.ID)) {
