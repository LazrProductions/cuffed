...
public class ModEntityTypes {
    ...
    public static RegistryObject<EntityType<WeightedAnchorEntity>> WEIGHTED_ANCHOR = ENTITY_TYPES.register("weighted_anchor",
            () -> EntityType.Builder.<WeightedAnchorEntity>of(WeightedAnchorEntity::new, MobCategory.MISC)
                    .sized(8 / 16f, 0.5f).canSpawnFarFromPlayer().fireImmune().clientTrackingRange(10)
