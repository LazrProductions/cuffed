...
public class ModEntityTypes {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, CuffedMod.MODID);
    ...
    public static RegistryObject<EntityType<ChainKnotEntity>> CHAIN_KNOT = 
        ...
        () -> EntityType.Builder.<ChainKnotEntity>of(ChainKnotEntity::new, MobCategory.MISC)
            ...
            .sized(6/16f, 0.5f).canSpawnFarFromPlayer().fireImmune().build(new ResourceLocation(CuffedMod.MODID, "chain_knot").toString()));
