...
public class HumanoidAnimationHelper {
    public static void renderHandcuffedAnimation(LivingEntity entity, HumanoidModel<LivingEntity> model, float f1,
        ...
        if (!entity.isCrouching()) {
            ...
            rightArm.xRot = 65 * Mth.DEG_TO_RAD;

            leftArm.yRot = -30 * Mth.DEG_TO_RAD;
            leftArm.xRot = 65 * Mth.DEG_TO_RAD;
        }
        
        model.hat.copyFrom(head);
    }

    public static void renderChainedAnimation(LivingEntity entity, HumanoidModel<LivingEntity> model, float f1,
            float f2, float f3, float headYRot, float headXRot) {
        renderDefaultHumanoidAnimation(entity, model, f1, f2, f3, headYRot, headXRot);
        ...
        rightArm.yRot = -30 * Mth.DEG_TO_RAD;
        rightArm.xRot = -55 * Mth.DEG_TO_RAD;

        leftArm.yRot = 30 * Mth.DEG_TO_RAD;
        leftArm.xRot = -55 * Mth.DEG_TO_RAD;

        model.hat.copyFrom(head);
    }

    public static void renderPilloryDetainedAnimation(LivingEntity entity, HumanoidModel<LivingEntity> model, float f1,
    ...
    public static void renderDefaultHumanoidAnimation(LivingEntity entity, HumanoidModel<LivingEntity> model, float f1,
            float f2, float f3, float headYRot, float headXRot) {
        ModelPart head = model.head;
        ModelPart body = model.body;
        ModelPart leftLeg = model.leftLeg;
    ...
    public static void renderFirstPersonHandcuffedAnimation(LivingEntity entity, HumanoidModel<LivingEntity> model, float f1,
            float f2, float f3, float headYRot, float headXRot) {
        //renderDefaultHumanoidAnimation(entity, model, f1, f2, f3, headYRot, headXRot);
