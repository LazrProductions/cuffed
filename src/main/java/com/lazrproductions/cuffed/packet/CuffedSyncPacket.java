...
public class CuffedSyncPacket extends CreativePacket {
    public int playerId;
    public String playerUUID;

    public String data = "null";

    public CuffedSyncPacket(int playerId, String uuid, CompoundTag data) {
    ...
    public CuffedSyncPacket(int playerId, String uuid, String data) {
        this.playerId = playerId;
        this.playerUUID = uuid;
    ...
    public void executeClient(Player arg0) {
        if (!data.equals("null")) {
            try {
                ...
                if(p != null)
                    CuffedAPI.Capabilities.getCuffedCapability(p).deserializeNBT(parsedTag);
